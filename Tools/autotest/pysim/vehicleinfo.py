class VehicleInfo(object):
            ...
            "ArduCopter": {
                ...
                "frames": {
                    ...
                    "X": {
                        ...
                        "extra_mavlink_cmds":
                        "param fetch frame; param set FRAME 1;",
                    },
                    "bfx": {
                        "make_target":
                        "sitl",
                    ...
                    "singlecopter": {
                        ...
                        "bin/arducopter",
                        "default_params_filename":
                        "default_params/copter-single.parm",
                    },
                    "coaxcopter": {
                        "make_target":
                        "sitl",
            ...
            "ArduPlane": {
                ...
                "frames": {
                    ...
                    "plane-vtail": {
                        ...
                        "default_params_filename": [
                            "default_params/plane.parm",
                            "default_params/plane-vtail.parm"
                        ],
                    },
                    "plane-tailsitter": {
                        "waf_target":
                        "bin/arduplane",
                        "default_params_filename":
                        "default_params/plane-tailsitter.parm",
                    },
                    "plane-jet": {
                        "waf_target":
                        "bin/arduplane",
                    ...
                    "gazebo-zephyr": {
                        ...
                        "bin/arduplane",
                        "default_params_filename":
                        "default_params/gazebo-zephyr.parm",
                    },
                    "last_letter": {
                        "waf_target": "bin/arduplane",
                    },
            ...
            "APMrover2": {
                ...
                "frames": {
                    ...
                    "gazebo-mimree-asv": {
                        ...
                        "default_params_filename": [
                            "default_params/rover.parm",
                            "default_params/gazebo-mimree-asv.parm"
                        ],
                    },
                    "airsim-rover": {
                        "waf_target":
    ...
    def options_for_frame(self, frame, vehicle, opts):
        ...
        if frame in frames:
            ...
            for p in [
                    "octa", "tri", "y6", "firefly", "heli", "gazebo",
                    "last_letter", "jsbsim", "quadplane", "plane-elevon",
                    "plane-vtail", "plane", "airsim"
            ]:
        ...
        if (ret["model"].find("xplane") != -1
                or ret["model"].find("flightaxis") != -1):
            ret["sitl-port"] = False
